...
export const MyCommandCell = props => {
  ...
  return inEdit ? <td className="k-command-cell">
      ...
      <button className="k-button k-button-md k-rounded-md k-button-solid k-button-solid-base k-grid-remove-command" onClick={() => confirm("Confirm deleting: " + dataItem.ProductName) && props.remove(dataItem)}>
        Remove
      </button>
    </td>;
};