...
function WorkingGrid() {
    ...
    const employeeGridStyles = { height: '720px', width: '100%' }
    ...
    return (
        ...
        >
            ...
            <Column field="status" title="Status" width="140px" />
            <Column field="firstName" title="First Name" width="140px" />
            <Column field="lastName" title="Last Name" width="140px" />
            <Column field="phone" title="Phone" width="140px" />
            <Column field="email" title="Email" width="140px" />
            <Column field="address" title="Address" width="140px" />
            <Column field="street" title="Street" width="140px" />
            <Column field="city" title="City" width="140px" />
            <Column field="state" title="State" width="140px" />
