...
const EmployeeModal = ({ open, handleModal ,setEmployeeList}) => {
  ...
  const onSubmit = () => {
    ...
    createEmployee({entryDate, employeeId, firstName, lastName, status, email, phone, address, street, city, state,zip,},userAccessToken)
      ...
      <ModalBody className="pb-5 px-sm-4 mx-50">
        ...
        <Row tag="form" className="gy-1 gx-2" >
          ...
          <Col xs={12} md={6}>
            ...
            <Controller
              ...
              render={({ field }) => (
                <Input
                  id="lastName"
                  placeholder="Doe" innerRef={lastNameRef}
          ...
          <Col xs={12}>
            ...
            <Input id="addressLine1" innerRef={addressOneRef} placeholder="12, Business Park" />
          </Col>
          <Col xs={12}>
            <Label className="form-label" for="addressLine2">
              Address Line 2
            </Label>
            <Input id="addressLine2" innerRef={addressTwoRef} placeholder="Mall Road" />
          </Col>
          <Col xs={12}>
            <Label className="form-label" for="city">
              City
            </Label>
            <Input id="city" innerRef={cityRef} placeholder="Ex : Los Angeles" />
          </Col>
          <Col xs={12} md={6}>
            <Label className="form-label" for="state-province">
              State / Province
            </Label>
            <Input id="state-province" innerRef={stateRef} placeholder="California" />
          </Col>
          <Col xs={12} md={6}>
